...
/**
 * Created with IntelliJ IDEA. User: pragone Date: 27/04/2014 Time: 6:05 PM To
...
public class RadialHashAlgorithmTest
{
	...
	public void testHashSerialization() throws IOException
	{
		...
		RadialHash hash2 = new RadialHash(serialized);
	...
	public void testEarthDistance() throws IOException
	{
		Assert.assertEquals(EARTHS_DISTANCE,
		        RadialHashAlgorithm.getSimilarity(new RadialHash(EARTH1_HASH), new RadialHash(EARTH2_HASH)), 0.000001);
	}
	...
	public void testEarthResizedDistance() throws IOException
	{
		Assert.assertEquals(EARTH_RESIZED_DISTANCE,
		        RadialHashAlgorithm.getSimilarity(getHashFor("earth1.jpg"), getHashFor("earth1_resized.jpeg")),
		        0.000001);
	}
	...
	public void testEarthCroppedDistance() throws IOException
	{
		Assert.assertEquals(EARTH_CROPPED_DISTANCE,
		        RadialHashAlgorithm.getSimilarity(getHashFor("earth1.jpg"), getHashFor("earth1_cropped.jpeg")),
		        0.000001);
	}
	...
	public void testEarthCaptionDistance() throws IOException
	{
		Assert.assertEquals(EARTH_CAPTION_DISTANCE,
		        RadialHashAlgorithm.getSimilarity(getHashFor("earth1.jpg"), getHashFor("earth1_caption.jpeg")),
		        0.000001);
	}
	//
	// @Test
	...
	// getClass().getClassLoader().getResourceAsStream("earth1.jpg");
	...
	// InputStream inputStream =
	// getClass().getClassLoader().getResourceAsStream("earth1_caption.jpeg");
	// BufferedImage img = ImageIO.read(inputStream);
	...
	// InputStream inputStream =
	// getClass().getClassLoader().getResourceAsStream("earth1_resized.jpeg");
	// BufferedImage img = ImageIO.read(inputStream);
